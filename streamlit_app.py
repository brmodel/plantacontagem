...
def criar_mapa(data, geojson_data):
    m = folium.Map(location=CENTRO_INICIAL_MAPA, tiles="http://services.arcgisonline.com/arcgis/rest/services/Canvas/World_Light_Gray_Base/MapServer/tile/{z}/{y}/{x}", zoom_start=ZOOM_INICIAL_MAPA, control_scale=True)
